...
execute "syntax region RequirementsBlock matchgroup=RequirementsKind start ='" . s:pattern . "' end='" . s:end_pattern . "' fold"

syntax match RequirementsLine      '\d' contained
let s:pattern = '\([' . s:ics . '] \?\)\@<=Lines$'
execute "syntax region RequirementsLineBlock matchgroup=RequirementsLineGroupStart start='" . s:pattern . "' end='^$' contains=RequirementsLine" 
